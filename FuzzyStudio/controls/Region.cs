...
namespace fuzzyStudio.controls
{
    ...
    ///
    /// </summary>
    public class Region : Expander
    {
        public static readonly DependencyProperty HeaderBackgroundProperty = DependencyProperty.Register("HeaderBackground", typeof(Brush), typeof(Region));
